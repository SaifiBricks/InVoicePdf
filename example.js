...
// Basic - shows what a default table looks like -----X
...
// Minimal - shows how compact tables can be drawn  ------X
...
// Long data - shows how the overflow features looks and can be used -----X
...
// Content - shows how tables can be integrated with any other pdf content ---X
...
// Multiple - shows how multiple tables can be drawn both horizontally and vertically -------X
...
examples['header-footer'] = function () {
  ...
  doc.autoTable({
    ...
    willDrawPage: function (data) {
      ...
      // doc.setTextColor(40)
      //custom-font
      doc.addFileToVFS('/TTF-Folder/Manrope-SemiBold.ttf', manRopeSemiBold);
      doc.addFont('/TTF-Folder/Manrope-SemiBold.ttf', 'custom', 'normal');
      doc.setFont('custom');
      ...
      doc.setFontSize(9);
      //custom-font-files
      doc.addFileToVFS('/TTF-Folder/Manrope-Regular.ttf', manRopeRegular);
      doc.addFont('/TTF-Folder/Manrope-Regular.ttf', 'Regular', 'normal');


      // Position for the bold text
      var boldTextX = 160;
      var boldTextY = 20;
      // Position for the light text
      var lightTextX = boldTextX + doc.getTextWidth("Date: ");
      var lightTextY = boldTextY;

      // Set the font for bold text
      doc.setFont('custom');
      doc.text(boldTextX, boldTextY, 'Date: ');
      // Set the font for light text
      doc.setFont('Regular');
      doc.text(lightTextX, lightTextY, formattedDate);
    ...
    didDrawPage: function (data) {
      ...
      //custom-font
      doc.addFileToVFS('/TTF-Folder/Manrope-Medium.ttf', manRopeMedium);
      doc.addFont('/TTF-Folder/Manrope-Medium.ttf', 'Medium', 'normal');
      doc.setFont('Medium');
      doc.setFontSize(14)
      ...
      // doc.text(str, data.settings.margin.left + 15, pageHeight - 8);
      if (base64Img) {
        doc.text('Powered By', data.settings.margin.left, 290)
        doc.addImage(base64Img, 'JPEG', data.settings.margin.left + 31, 283, 35, 9)
        doc.text('www.Ibricks.io', data.settings.margin.left + 150, 289)
      }
    },
    margin: { top: 30 },
  ...
  doc.autoTable({
    ...
    didParseCell: function (data) {
      ...
      if (data.row.section === "body" && data.row.index === 1 && data.cell === data.row.cells[1]) {
        ...
        data.cell.styles.lineColor = 'black' // cell border color
        data.cell.styles.lineWidth = {
